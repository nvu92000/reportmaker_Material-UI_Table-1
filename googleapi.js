...
function authorize(credentials, callback) {
  ...
  fs.readFile(TOKEN_PATH, (err, token) => {
    ...
    // callback(oAuth2Client, "1OhHK9dtvb0rmkgquv8S4wFaYm0JrGLzj"); //get file to download...
  });
}
...
function uploadFile(auth) {
  const drive = google.drive({ version: "v3", auth });
  var fileMetadata = {
    name: "20191201_20191207_Kyoko.xlsx",
  };
  var media = {
    mimeType:
      "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
    body: fs.createReadStream("20191201_20191207_Kyoko.xlsx"),
  };
  drive.files.create(
    {
