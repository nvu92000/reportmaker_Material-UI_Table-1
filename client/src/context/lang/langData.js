const langData = {
  ...
  ja: {
    ...
    login: {
      ...
      _whatIsYourEmail: "あなたのメアドは何ですか？",
      _notaValidEmail: "入力は有効なメールではありません！",
      ...
      _emailNotExists:
        "このメールはデータベースに存在しません。 管理者にお問い合わせください。",
    },
    home: {
  ...
  vi: {
    ...
    login: {
      ...
      _emailPrompt: "Vui lòng nhập email của bạn!",
      ...
      _whatIsYourEmail: "Email của bạn là gì?",
      _notaValidEmail: "Đây vào không phải là một email hợp lệ!",
      ...
      _emailNotExists:
        "Email này không tồn tại trong cơ sở dữ liệu. Vui lòng liên hệ với admin để được hỗ trợ!",
    },
    home: {
  ...
  zh: {
    ...
    login: {
      ...
      _whatIsYourEmail: "您的电子邮件是什么？",
      _notaValidEmail: "输入的电子邮件无效！",
  ...
  ko: {
    ...
    login: {
      ...
      _whatIsYourEmail: "당신의 이메일은 무엇인가요?",
      _notaValidEmail: "입력하신 이메일이 유효하지 않습니다!",
      ...
      _emailNotExists:
        "이 이메일은 데이터베이스에 없습니다. 도움이 필요하면 관리자에게 문의하십시오!",
    },
