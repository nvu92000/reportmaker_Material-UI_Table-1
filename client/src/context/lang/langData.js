const langData = {
  ...
  ja: {
    ...
    login: {
      ...
      _notaValidEmail: "入力は有効なテクノスターのメールではありません！",
  ...
  vi: {
    ...
    login: {
      ...
      _notaValidEmail: "Đây vào không phải là một email TechnoStar hợp lệ!",
  ...
  zh: {
    ...
    login: {
      ...
      _notaValidEmail: "输入的不是有效的TechnoStar电子邮件！",
  ...
  ko: {
    ...
    login: {
      ...
      _notaValidEmail: "입력 한 내용은 유효한 TechnoStar 이메일이 아닙니다!",
